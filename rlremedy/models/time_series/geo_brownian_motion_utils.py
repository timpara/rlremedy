...
from rlremedy.models.time_series.univariate_brownian_motion import GeometricBrownianMotion
from utils.math.random_ops import multivariate_normal
...
def generate_sample_paths(mu, sigma, times, initial_state, supply_draws,
  ...
  """
  process = GeometricBrownianMotion(mu, sigma, dtype=dtype)
  normal_draws = None
  if supply_draws:
